...
JustWorks Project: Generating insight from a list of banking transactions
-----------------

Code Objective: To generate minimum , maximum and ending balances by monthYear
--------------
for all customers from the data given by JustWorks. 
...
folder are the Input csv which is the sample data given by JustWorks, the 
